...
import com.pixys.launcher.PixysLauncher;
import com.pixys.launcher.PixysLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        PixysLauncher launcher = (PixysLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        PixysLauncherModelDelegate delegate = (PixysLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        PixysLauncher launcher = (PixysLauncher) ActivityContext.lookupContext(getContext());
