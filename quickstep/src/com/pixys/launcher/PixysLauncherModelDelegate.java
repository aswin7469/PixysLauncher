...
public class PixysLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "PixysLauncherModelDelegate";
    ...
    public PixysLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
